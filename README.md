...
(Tested on Ubuntu 16.04 x86, 17.10 x86, 16.10 x64, Gentoo x64 and Linux Mint 18 "Sarah" - Cinnamon x64)
...
4. Install the GUI dependencies
  ...
  - For Ubuntu 16.04+ x64
    ...
    `sudo apt install qtbase5-dev qt5-default qtdeclarative5-dev qml-module-qtquick-controls qml-module-qtquick-xmllistmodel qttools5-dev-tools qml-module-qtquick-dialogs qml-module-qt-labs-settings libqt5qml-graphicaleffects qml-module-qt-labs-settings`
